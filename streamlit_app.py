...
st.html(
   "<br>"
    "<p>لاحظنا أن أكثر الأسعار ارتفاعا في شمال الرياض و وجدنا أن المطار و أكاديمية طويق جامعة الأميرة نورة وجامعة الإمام محمد بن سعود 
    و بوليفارد  الرياض يكون قريب من الشمال مما أدى الى ارتفاع الاسعار بشكل ملحوظ كما نلاحظ في الرسم البياني</p>"
)
data = pd.DataFrame({
